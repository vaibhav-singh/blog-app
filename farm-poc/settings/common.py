...
"""
Django settings for farm-poc project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '5ism2i%@s%)s+g#8%u=p&g6zoyo!o%=avskk4%wsqe-p0gd!o-')
...
WSGI_APPLICATION = 'farm-poc.wsgi.application'
...
# See .ebextensions/farm-poc.config
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {
            ...
            'when': 'midnight',
            'backupCount': 10,
            'filename': os.path.join(LOG_DIR, 'farm-poc.log'),
            'formatter': 'verbose',
        },
        'console': {
            'level': 'DEBUG',
